...
class DmMarker:
    ...
    def __init__(self, drawer, draw_type=None,
                 change_mode="cm_copy",   # ??? KbdCmdProc.CM_COPY
                 heading=None,
        ...
        :draw_type: marker drawing type
                    REQUIRED
        :change_mode: Type operation copy/move/goto operation on destination
        ...
        if change_mode is None:
            change_mode = drawer.get_change_mode()
